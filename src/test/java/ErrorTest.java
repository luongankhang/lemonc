...
/**
 * Negative tests - verify compiler reports errors correctly on invalid input.
...
public class ErrorTest {
    ...
    public void testReturnTypeMismatch() throws IOException {
        // Return value mismatch with declared type should report semantic error
        compileSource("class Test { void main() { int x; x = foo(); } int foo() { return true; } }");
    }

    @Test(expected = SemanticException.class)
    public void testUseBeforeAssign() throws IOException {
        // Local variable used before assignment should report semantic error
    ...
    public void testAndOperatorNonBool() throws IOException {
        // && operator operands not bool should report semantic error
    ...
    public void testCompareTypeMismatch() throws IOException {
        // Numeric types can be promoted; non-numeric types in ordinal comparison should still report semantic error
    ...
    /**
     * Write source string to temporary file and execute full compilation pipeline.
     * Used to verify compiler correctly throws exceptions on invalid input.
     */
    private void compileSource(String source) throws IOException {
        // Extract class name from source as filename
